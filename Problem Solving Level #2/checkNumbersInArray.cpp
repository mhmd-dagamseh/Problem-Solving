...
short searchAboutNumber(int searchNumber,int arrLength,int arr[]) 
{
...
bool isNumberInArray(int searchNumber,int arrLength,int arr[]) 
{
   return searchAboutNumber(searchNumber,arrLength,arr) != -1;
}
int main() {
      ...
      bool index = isNumberInArray(searchNumber,arrLength,arr);
      if (!index) {
