...
void countEvenNumbers( int arr[], int arrLength,bool isOdd[],int &Counter)
{
    for (int i = 0; i < arrLength; i++)
    {
       if (isOdd[i] == false) {
...
int main() {
    ...
    countEvenNumbers(arr, arrLength,Answer,Counter);
    cout << endl;
    cout << "count of even numbers are " << Counter << endl;
   system("pause");
}
